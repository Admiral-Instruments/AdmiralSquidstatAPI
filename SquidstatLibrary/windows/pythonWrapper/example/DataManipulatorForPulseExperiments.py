...
def create_logic(handler):
    ...
    def on_experiment_stopped(channel):
        print(f"Experiment has completed on channel {channel}")
...
def main():
    ...
    def on_new_device_connected(device_name):
        ...
        handler.uploadExperimentToChannel(experimentChannel, experiment)
        
        # start experiment on device on defined channel
        handler.startUploadedExperiment(experimentChannel)
