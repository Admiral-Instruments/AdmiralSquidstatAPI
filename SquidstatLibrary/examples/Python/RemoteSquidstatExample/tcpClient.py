"""! @example tcpClient.py This example file shows how to create a TCP client which can send commands to a server that is connected to a Squidstat.

You can build experiments and recieve data from the server without having to interact with the instrument directly.
"""
...
# listens for <CTRL>+c to stop the client script
