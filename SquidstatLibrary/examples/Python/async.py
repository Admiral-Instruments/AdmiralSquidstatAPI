...
def experiment_complete_handler(channel, reason):
    print(f"Experiment Completed on channel {channel} , {reason}")
...
async def main():
    ...
    success &= subExperiment.appendElement(cvElement, 2)

    # add constant current experiment to position 1 and 2 of the main experiment
    # this experiment will run 2 times
    success &= experiment.appendElement(ccElement, 2)
