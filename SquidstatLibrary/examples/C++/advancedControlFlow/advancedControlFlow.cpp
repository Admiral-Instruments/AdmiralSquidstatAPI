/*!
* \example advancedControlFlow.cpp
* This example shows how we can setup an advanced control flow for a sequence of experiments.
* For simplicity we will be using an incremented integer as an external condition to control the workflow.
* This logic can be replaced with any sort of logic pertaining to external instruments, sensors, or any other conditions.
*/
