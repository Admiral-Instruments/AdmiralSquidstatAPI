...
#include "experiments/builder_elements/AisEISPotentiostaticElement.h"
...
int main()
{
	...
	*/
    ...
    // We create another element of a different type
    AisEISPotentiostaticElement eisPElement( // construct a Eis Potentiostatic element and assign it to "eisPElement"
        10000, // start frequency : 10kHz
        1, // end frequency : 1 Hz
        10, // step per decade : 10
        0.15, // DC bias Voltage : 0.15 V
        0.1 // Voltage Amplitude : 100 mV
    );
    ...
    customExperiment->appendElement(eisPElement, 1); // append the Eis Potentiostatic element to the end of the experiment and set it to run 1 time
